...
// Template and Content Library Settings, if set template_conversion false, the image will copy to the defined content-labrary
// The Microsoft Windows 11 machine image is not transferred to the content library by default. 
